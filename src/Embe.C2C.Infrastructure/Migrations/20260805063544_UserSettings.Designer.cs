...
namespace Embe.C2C.Infrastructure.Migrations
{
    ...
    [Migration("20260805063544_UserSettings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Embe.C2C.Domain.Aggregates.Users.User", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Settings", "Embe.C2C.Domain.Aggregates.Users.User.Settings#UserSettings", b1 =>
                        {
                            b1.IsRequired();

                            b1.Property<bool>("DeviceNotifications")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                            ...
                            b1.Property<bool>("NotifyOnLike")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true);

                            b1.Property<bool>("NotifyOnMatch")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true);

                            b1.Property<bool>("NotifyOnMessage")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true);
                        });
            ...
            modelBuilder.Entity("Embe.C2C.Infrastructure.Ef.Entities.SearchProfileEmbedding", b =>
                {
                    ...
                    b.ToTable("SearchProfileEmbeddings");
                });

            modelBuilder.Entity("Embe.C2C.Infrastructure.Ef.Entities.VerificationCode", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Embe.C2C.Domain.Aggregates.Notifications.Messages.MessageNotification", b =>
                {
                    b.HasBaseType("Embe.C2C.Domain.Aggregates.Notifications.Notification");
            ...
            modelBuilder.Entity("Embe.C2C.Domain.Aggregates.Notifications.Matchings.MatchingCreatedNotification", b =>
                {
            ...
            modelBuilder.Entity("Embe.C2C.Domain.Aggregates.Notifications.Messages.MessageCreatedNotification", b =>
                {
                    b.HasBaseType("Embe.C2C.Domain.Aggregates.Notifications.Messages.MessageNotification");

                    b.HasDiscriminator().HasValue("MessageCreatedNotification");
                });
            ...
            modelBuilder.Entity("Embe.C2C.Domain.Aggregates.Matchings.Matching", b =>
                {
                    b.HasOne("Embe.C2C.Domain.Aggregates.Messages.Message", "LastMessage")
                        .WithOne()
                        .HasForeignKey("Embe.C2C.Domain.Aggregates.Matchings.Matching", "LastMessageId")
            ...
            modelBuilder.Entity("Embe.C2C.Infrastructure.Ef.Entities.SearchProfileEmbedding", b =>
                {
                    b.HasOne("Embe.C2C.Domain.Aggregates.SearchProfiles.SearchProfile", null)
                        .WithOne()
                        .HasForeignKey("Embe.C2C.Infrastructure.Ef.Entities.SearchProfileEmbedding", "SearchProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Embe.C2C.Infrastructure.Identity.MyIdentityUser", b =>
                {
                    b.HasOne("Embe.C2C.Domain.Aggregates.Users.User", null)
                        .WithOne()
                        .HasForeignKey("Embe.C2C.Infrastructure.Identity.MyIdentityUser", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
