...
export default function SearchProfiles({ className, searchProfiles: initialSearchProfiles }: SearchProfilesProps) {
    ...
    return (
        <Surface className={`${classNames} flex flex-col gap-2 w-full`} variant="inherit" padding="none">
            <div className="flex flex-row gap-1 items-center justify-between">
                <BackButton />
                <h1>search profiles</h1>
                <Button
                    className="max-w-max max-h-max flex flex-row gap-1 items-center justify-between"
                    intent="create"
